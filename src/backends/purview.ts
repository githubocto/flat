...
export default async function fetchPurview(
  ...
  if (
    typeof term.assignedEntities === 'undefined' ||
    term.assignedEntities === null
  ) {
  ...
  await client
    .sendRequest(req2)
    .then(function (res: msRest.HttpOperationResponse) {
