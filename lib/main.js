...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        core.debug('*** ls');
        core.debug(child_process_1.execSync('ls').toString());
        core.debug('*** ls ~/work/_actions/githubocto/flat/postprocessing/src');
        core.debug(child_process_1.execSync('ls ~/work/_actions/githubocto/flat/postprocessing/src').toString());
        ...
        if (config.postprocess) {
            ...
            try {
                ...
                filename = child_process_1.execSync(`deno run -A ~/work/_actions/githubocto/flat/postprocessing/postprocess/postprocess_shim.ts ${config.postprocess} ${filename}`).toString();
            }
            catch (error) {
