...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        core.debug(`*** __filename/../postprocess/shim.ts: ${path_1.join(__filename, '../postprocess/shim.ts')}`);
        ...
        if (config.postprocess) {
            ...
            try {
                ...
                filename = child_process_1.execSync(`deno run -A ${path_1.join(__filename, '../postprocess/shim.ts')} ${config.postprocess} ${filename}`).toString();
            }
            catch (error) {
